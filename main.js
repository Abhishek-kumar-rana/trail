var typed= new Typed(".text",{
    strings:["bachlor Student.", "frontend Developer.", "web Developer.", "MERN-stack Developer."],
    typeSpeed:100,
    backSpeed:100,
    backDelay:1000,
    loop:true
...
sr.reveal('.about-img,.ctr2',{delay:350,origin:'left'})
sr.reveal('.about-img, .ctr1',{delay:350,origin:'right'})
sr.reveal('.row1, .contact-form, .propic',{delay:350,origin:'bottom'})
